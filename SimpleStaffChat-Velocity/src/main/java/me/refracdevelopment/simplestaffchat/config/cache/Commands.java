...
public class Commands {
    ...
    public void loadConfig() {
        ...
        STAFFCHAT_COMMAND_ALIASESES = SimpleStaffChat.getInstance().getCommandsFile().getStringList("commands.staffchat.aliases");

        STAFF_TOGGLE_COMMAND_PERMISSION = SimpleStaffChat.getInstance().getCommandsFile().getString("commands.toggle.permission");
        STAFF_TOGGLE_COMMAND_ALIASESES = SimpleStaffChat.getInstance().getCommandsFile().getStringList("commands.toggle.aliases");

        ADMINCHAT_COMMAND_PERMISSION = SimpleStaffChat.getInstance().getCommandsFile().getString("commands.adminchat.permission");
        ADMINCHAT_COMMAND_ALIASESES = SimpleStaffChat.getInstance().getCommandsFile().getStringList("commands.adminchat.aliases");

        ADMIN_TOGGLE_COMMAND_PERMISSION = SimpleStaffChat.getInstance().getCommandsFile().getString("commands.admin-toggle.permission");
        ADMIN_TOGGLE_COMMAND_ALIASESES = SimpleStaffChat.getInstance().getCommandsFile().getStringList("commands.admin-toggle.aliases");

        DEVCHAT_COMMAND_PERMISSION = SimpleStaffChat.getInstance().getCommandsFile().getString("commands.devchat.permission");
        DEVCHAT_COMMAND_ALIASESES = SimpleStaffChat.getInstance().getCommandsFile().getStringList("commands.devchat.aliases");

        DEV_TOGGLE_COMMAND_PERMISSION = SimpleStaffChat.getInstance().getCommandsFile().getString("commands.dev-toggle.permission");
        DEV_TOGGLE_COMMAND_ALIASESES = SimpleStaffChat.getInstance().getCommandsFile().getStringList("commands.dev-toggle.aliases");

        CHAT_COMMAND_PERMISSION = SimpleStaffChat.getInstance().getCommandsFile().getString("commands.chat.permission");
        CHAT_COMMAND_ALIASESES = SimpleStaffChat.getInstance().getCommandsFile().getStringList("commands.chat.aliases");

        HIDE_COMMAND_PERMISSION = SimpleStaffChat.getInstance().getCommandsFile().getString("commands.hide.permission");
        HIDE_COMMAND_ALIASESES = SimpleStaffChat.getInstance().getCommandsFile().getStringList("commands.hide.aliases");
    }
}