...
/** Taken from https://github.com/RyanMoodGAMING/RyUtils */
@SuppressWarnings("unused")
public class RyMessageUtils {

    @Setter
    private static Plugin instance = SimpleStaffChat.getInstance();
    @Setter
    @Getter
    private static BukkitAudiences audiences = BukkitAudiences.create(instance);
     ...
     *
     * @param commandSender The player who you wish to receive the message.
     * @param message The message you wish to send the player.
     */
    public static void sendPlayer(@NotNull CommandSender commandSender, @NotNull String message) {
