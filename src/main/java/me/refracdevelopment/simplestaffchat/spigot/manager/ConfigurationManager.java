...
public class ConfigurationManager extends AbstractConfigurationManager {
    ...
    public enum Setting implements RoseSetting {
        ...
        MINECRAFT_FORMAT("minecraft-format", "&8[&c&lStaffChat&8] &e(%server%) &6&l%player%&7: &f%message%", "Minecraft format"),
        CONSOLE_FORMAT("console-format", "&8[&c&lStaffChat&8] &e(%server%) &6&lConsole&7: &f%message%", "Format for messages sent by the console", "PlaceholderAPI is not supported here"),
        ADMINCHAT_FORMAT("adminchat-format", "&8[&4&lAdminChat&8] &e(%server%) &6&l%player%&7: &f%message%", "AdminChat format"),
        CONSOLE_ADMINCHAT_FORMAT("console-adminchat-format", "&8[&4&lAdminChat&8] &e(%server%) &6&lConsole&7: &f%message%", "Format for messages sent by the console", "PlaceholderAPI is not supported here"),
        DEVCHAT_FORMAT("devchat-format", "&8[&b&lDevChat&8] &e(%server%) &6&l%player%&7: &f%message%", "DevChat format"),
        CONSOLE_DEVCHAT_FORMAT("console-devchat-format", "&8[&b&lDevChat&8] &e(%server%) &6&lConsole&7: &f%message%", "Format for messages sent by the console", "PlaceholderAPI is not supported here"),
        ...
        JOIN_QUIT_FORMAT("join.quit-format", "&8[&c-&8] &9%player% &fleft &e%server%&f."),
