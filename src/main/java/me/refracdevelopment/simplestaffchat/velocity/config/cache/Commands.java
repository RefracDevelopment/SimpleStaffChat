...
public class Commands extends Manager {
    ...
    public List<String> STAFF_HIDE_COMMAND_ALIASESES;
    public boolean ADMIN_HIDE_COMMAND_ENABLED;
    public String ADMIN_HIDE_COMMAND_PERMISSION;
    public List<String> ADMIN_HIDE_COMMAND_ALIASESES;
    public boolean DEV_HIDE_COMMAND_ENABLED;
    public String DEV_HIDE_COMMAND_PERMISSION;
    public List<String> DEV_HIDE_COMMAND_ALIASESES;

    public Commands(VelocityStaffChat plugin) {
        super(plugin);
        loadConfig();
    }
    ...
    public void loadConfig() {
        ...
        STAFFCHAT_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.staffchat.aliases");
        ...
        STAFF_TOGGLE_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.toggle.aliases");
        ...
        ADMINCHAT_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.adminchat.aliases");
        ADMIN_TOGGLE_COMMAND_ENABLED = plugin.getCommandsFile().getBoolean("commands.admin-toggle.enabled");
        ADMIN_TOGGLE_COMMAND_PERMISSION = plugin.getCommandsFile().getString("commands.admin-toggle.permission");
        ADMIN_TOGGLE_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.admin-toggle.aliases");
        ...
        DEVCHAT_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.devchat.aliases");
        ...
        DEV_TOGGLE_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.dev-toggle.aliases");
        ...
        CHAT_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.chat.aliases");
        ...
        STAFF_HIDE_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.hide.aliases");
        ...
        ADMIN_HIDE_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.admin-hide.aliases");
        ...
        DEV_HIDE_COMMAND_ALIASESES = plugin.getCommandsFile().getStringList("commands.dev-hide.aliases");
    }
}