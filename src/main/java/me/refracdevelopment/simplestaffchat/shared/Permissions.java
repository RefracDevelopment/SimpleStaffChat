...
public class Permissions {
    ...
    // Other
    public final String STAFFCHAT_RELOAD = "simplestaffchat.command.reload";
    public final String STAFFCHAT_SEE = "simplestaffchat.staffchat.see";
    ...
    public final String STAFFCHAT_HELP = "simplestaffchat.command.help";
