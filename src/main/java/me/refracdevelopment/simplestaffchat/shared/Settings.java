...
public class Settings {
    ...
    public static final String getName = "SimpleStaffChat";
    public static final String getDeveloper = "RefracDevelopment";
    ...
    public static final String getVersion = "2.8-beta.2";
