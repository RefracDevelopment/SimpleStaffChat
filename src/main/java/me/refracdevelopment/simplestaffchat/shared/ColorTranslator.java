...
/*
* Taken from the SimpAPI as I don't use all of it's features currently.
* https://github.com/Cortex-MC/SimpAPI/blob/master/src/main/java/me/kodysimpson/simpapi/colors/ColorTranslator.java
*/
